...
| Зарегистрированные пользователи | Пользователи, которые вошли в приложение, введя мастер-пароль, желающие просматривать свои пароли и использовать их. Имеют доступ к полному функционалу |
...
#### 3.1.1.6 Автоматический ввод пароля.
**Описание.** Пользователь имеет возможность удалять пароль из базы данных.
...
### 3.2.3 Ограничения 
Данные пользователя хранятся в файле с расширением txt, название файла pass.txt
